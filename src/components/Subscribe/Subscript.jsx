...
export default function Subscript() {
  return (
    <div className="container mx-auto mt-36 w-11/12 md:w-full border-2 p-4 border-gray-400 rounded-xl relative top-32 z-10">
      <div
      ...
      >
        ...
        <div className="flex gap-1">
          <label className="input input-bordered flex items-center gap-2">
            ...
            <input type="text" className="grow md:pr-16" placeholder='Enter Your Email' />
          </label>
